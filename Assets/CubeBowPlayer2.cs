...
public class CubeBowPlayer2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sliderHealth = GameObject.Find("CubeBowPlayer2HealthBar" + count.ToString()).GetComponent<Slider>(); //set initial slider value
        healthCanvas = GameObject.Find("CubeBowPlayer2HealthCanvas" + count.ToString());
    ...
    void Update()
    {
        ...
        if (health <= 0)
        {
            coinObjectParent = GameObject.Find("Player1Canvas");
